...
public class NVQLAttrValList {
    ...
    String getMixList4Neo4j(NVQLAttrDefList aDefList) {
        String list = "";
        ...
        for (String attr : attrVals.keySet()) {
            ...
            case "string":
                if (checkForString(attrVals.get(attr))) {
                    list = list + "`" + attr + "`:" + attrVals.get(attr).toString() + ",";
                    break;
                } else {
                    System.out.println(
            ...
            case "int":
                if (checkForInt(attrVals.get(attr))) {
                    list = list + "`" + attr + "`:" + attrVals.get(attr) + ",";
                    break;
                } else {
                    System.out.println(
                            "ERROR.NVQLAttrValList: Value for attribute " + attr + " does not match it's type");
    ...
    String getValueList4SQL_Modified(NVQLAttrDefList aDefList) {
